...
Ray system memory: this is memory used internally by Ray
  - **GCS (Global Control Store)**: memory used for storing the list of nodes and actors present in the cluster. The amount of memory used for these purposes is typically quite small.
